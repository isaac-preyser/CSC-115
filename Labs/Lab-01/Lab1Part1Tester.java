...
public class Lab1Part1Tester {
	...
	public static void testCountAbove() {
		...
		expected = 4;
		System.out.println("a2: (threshold -1): " + Lab1.getString(a2));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result);
		...
		expected = 1;
		System.out.println("a2 - threshold 2: " + Lab1.getString(a2));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result);

		result = Lab1.countAbove(a3,2);
		expected = 2;
		System.out.println("a3 - threshold 2: " + Lab1.getString(a3));
		System.out.println("should be: " + expected);
		System.out.println("returned: " + result);
	}
