...
public class Lab1 {
    ...
    public static String getString(int[] array) {
        ...
        for(int i = 0; i < array.length; i++) {
            if (i != array.length - 1) {result += array[i] + ",";} /* pretend I hit the enter key here */ else {result += array[i];}  
        }
    ...
    public static int countAbove(int[] array, int threshold) {
        ...
        for(int i=0; i<array.length; i++) {
            if (array[i]>threshold) {
                count++;
                // System.out.println(array[i] + " > " + threshold);
            } else {
                // System.out.println(array[i] + " < " + threshold);
            }
        }
    ...
    public static boolean isSorted(int[] array) {
        ...
        for(int i = 0; i < array.length; i++) {
            if (i == 0) {continue;} // dont check the first value; will get an outofbounds exception.
